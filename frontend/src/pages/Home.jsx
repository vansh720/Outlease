  ...
  return (
    <div className="relative bg-white overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-32 border-b border-gray-100">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div
          className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-slate-200 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-[-20%] left-[20%] w-[40%] h-[40%] bg-cyan-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="h-56 sm:h-48 relative">
              {/* Rent Content */}
              <div
                className={`absolute inset-0 transition-all duration-500 transform ${mode === "rent" ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}
              >
                ...
                <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
                  From power tools to party supplies. Rent high-quality items
                  from people in your neighborhood for a fraction of the cost.
                </p>
              </div>

              {/* Lend Content */}
              <div
                className={`absolute inset-0 transition-all duration-500 transform ${mode === "lend" ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4 pointer-events-none"}`}
              >
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-4 tracking-tight">
                ...
                <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
                  Your unused camera, drill, or camping gear could be making you
                  money. List it securely and start earning today.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 max-w-xl mx-auto lg:mx-0 pt-10">
              {mode === "rent" ? (
                ...
                <div className="flex flex-col sm:flex-row gap-4 relative z-20">
                  ...
                  <button
                    className="bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-2xl font-bold hover:border-gray-300 hover:bg-gray-50 transition-all flex items-center justify-center shadow-sm"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg">
            A safe, simple, and sustainable way to access the things you need
            without buying them.
          </p>
        </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Discover appliances, electronics, and more in your
                    neighborhood.
                  </p>
                </div>
                <button
                  className="text-teal-600 font-semibold flex items-center gap-1 hover:text-teal-700 transition-colors"
